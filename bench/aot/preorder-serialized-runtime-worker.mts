...
import { hydratePreorderAotRouterCandidate } from "./preorder-aot-candidate.mts";

import type { PreorderAotArtifactCandidate } from "./preorder-aot-candidate.mts";
...
if (scenario !== "current-flat" && scenario !== "preorder") {
...
const router =
  scenario === "current-flat"
    ...
    : hydratePreorderAotRouterCandidate(
        methodNames,

        (parsed as PreorderAotArtifactCandidate)[6],
