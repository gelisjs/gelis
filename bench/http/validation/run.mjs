...
async function prewarmRoutes(urls, benchmarkCase) {
  const batchSize = 100;
...
async function waitForServer(url, benchmarkCase) {
  let lastError;
...
function requestInit(benchmarkCase) {
...
async function runOha(urlFile, benchmarkCase, duration, connections) {
  const args = [
    "oha",
