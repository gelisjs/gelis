...
const BASELINE_ROOT = resolve(ROOT, "..", "gelis-baseline");
...
const frameworks = [
  {
    ...
    file: resolve(BASELINE_ROOT, "bench/http/servers/gelis.ts"),
...
console.log("\nGelis P5-D HTTP A/B — oha mixed routes");
...
writeFileSync(
  resolve(RESULTS_DIR, "latest-p5d-ab.json"),

  `${JSON.stringify(output, null, 2)}\n`,
);

console.log("\nRaw results: " + "bench/http/results/latest-p5d-ab.json");
