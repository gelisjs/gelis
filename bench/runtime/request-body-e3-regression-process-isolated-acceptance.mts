...
const CONTROL_SHA = "313adf97932a80b95b1d2e4f0f27039a51e74013";
const SAMPLES = 41;
...
const workerPath = resolve(
  currentDirectory,
  "request-body-e3-regression-process-worker.mts",
);

console.log("\nP9-E3 request body regression process-isolated acceptance\n");
...
console.log("\nP9-E3 request body regression acceptance summary\n");
console.table(
  results.map((result) => ({
...
if (failed.length !== 0) {
  throw new Error(
    `P9-E3 regression gate failed: ${failed
