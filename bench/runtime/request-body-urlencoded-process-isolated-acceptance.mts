...
const workerPath = resolve(
  currentDirectory,
  "request-body-urlencoded-process-worker.mts",
);

console.log("\nP9-E3-D urlencoded body reader process-isolated acceptance\n");
...
console.log("\nP9-E3-D urlencoded body reader acceptance summary\n");
console.table([
  {
    workload: "urlencoded managed/manual",
...
if (!pass) {
  throw new Error("P9-E3-D urlencoded body reader managed/manual gate failed");
}
