...
const workerPath = resolve(
  currentDirectory,
  "request-body-array-buffer-process-worker.mts",
);

console.log("\nP9-E3-C arrayBuffer body reader process-isolated acceptance\n");
...
console.log("\nP9-E3-C arrayBuffer body reader acceptance summary\n");
console.table([
  {
    workload: "arrayBuffer managed/manual",
...
if (!pass) {
  throw new Error("P9-E3-C arrayBuffer body reader managed/manual gate failed");
}
