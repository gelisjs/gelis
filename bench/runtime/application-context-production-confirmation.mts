...
const pairs: Pair[] = [
  ...
  {
    name: "scoped-dynamic-production",
...
console.log("\nGelis P8-A4.1 production application-context confirmation gate");
...
console.log(
  "Topology:      2500 plain static + 2500 production scoped dynamic",
);
  ...
  return (iterations) => {
    ...
    for (let index = 0; index < iterations; index++) {
      ...
      if (result instanceof Promise) {
        throw new Error(
          "Unexpected async result in P8-A4.1 synchronous benchmark",
        );
      }
...
function assertCorrectness(): void {
  ...
  if (
    ...
    throw new Error("Unexpected async result during P8-A4.1 correctness check");
  }
